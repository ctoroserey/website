...
[Here is an accuracy table for a popular 15 minute test](https://pellecome.com/wp-content/uploads/2020/03/ClungeneIFU-Amended.pdf). Compared to the molecular gold standard, this shows that the antibody test correctly identified 67 out of 77 positive cases, and 89 out 90 negatives (the diagonal numbers from the table versus the totals at the bottom). So we have (67 + 89) out of (77 + 90) correct = 93%. Sweet, we’re done! Kind of.
